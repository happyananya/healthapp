...
def cal():
    ...
    photo = ImageTk.PhotoImage(image.resize((1490, 850), PIL.Image.ANTIALIAS))
...
def dietplan():
    ...
    loc = 'bg1.jpg'
    image = PIL.Image.open(loc)
    photo = ImageTk.PhotoImage(image.resize((1450,850),PIL.Image.ANTIALIAS))
    ...
    def wdc():
        ...
        def age():
            ...
            if text=='':
                if loc!='':
                    image = PIL.Image.open(loc)
                    photo = ImageTk.PhotoImage(image.resize((700, 500), PIL.Image.ANTIALIAS))
                    label = Label(wd, image = photo)
                    label.image = photo
...
def workout():
    def monday1():
        ...
        loc = 'Monday1.png'
        image = PIL.Image.open(loc)
        photo = ImageTk.PhotoImage(image.resize((600,700),PIL.Image.ANTIALIAS), master=mon1)
    ...
    def tuesday1():
        ...
        loc='Tuesday1.png'
        image = PIL.Image.open(loc)
        photo = ImageTk.PhotoImage(image.resize((600,700),PIL.Image.ANTIALIAS), master=tue1)
    ...
    def thursday1():
        ...
        loc='Thursday1.png'
        image = PIL.Image.open(loc)
        photo = ImageTk.PhotoImage(image.resize((600,700),PIL.Image.ANTIALIAS), master=thu1)
    ...
    def friday1():
        ...
        loc='Friday1.png'
        image = PIL.Image.open(loc)
        photo = ImageTk.PhotoImage(image.resize((600,700),PIL.Image.ANTIALIAS), master=fri1)
    ...
    def saturday1():
        ...
        loc='Saturday1.png'
        image = PIL.Image.open(loc)
        photo = ImageTk.PhotoImage(image.resize((600,700),PIL.Image.ANTIALIAS), master=sat1)
    ...
    def beginner():
        ...
        loc='wpf.jpg'
        image = PIL.Image.open(loc)
        photo = ImageTk.PhotoImage(image.resize((1490,850),PIL.Image.ANTIALIAS), master=beg)
    ...
    def monday2():
        ...
        loc='Monday2.png'
        image = PIL.Image.open(loc)
        photo = ImageTk.PhotoImage(image.resize((600,700),PIL.Image.ANTIALIAS), master=mon2)
    ...
    def tuesday2():
        ...
        loc='Tuesday2.png'
        image = PIL.Image.open(loc)
        photo = ImageTk.PhotoImage(image.resize((600,700),PIL.Image.ANTIALIAS), master=tue2)
    ...
    def thursday2():
        ...
        loc='Thursday2.png'
        image = PIL.Image.open(loc)
        photo = ImageTk.PhotoImage(image.resize((600,700),PIL.Image.ANTIALIAS), master=thu2)
    ...
    def friday2():
        ...
        loc='Friday2.png'
        image = PIL.Image.open(loc)
        photo = ImageTk.PhotoImage(image.resize((600,700),PIL.Image.ANTIALIAS), master=fri2)
    ...
    def saturday2():
        ...
        loc='Saturday2.png'
        image = PIL.Image.open(loc)
        photo = ImageTk.PhotoImage(image.resize((600,700),PIL.Image.ANTIALIAS), master=sat2)
    ...
    def intermediate():
        ...
        loc='wpf.jpg'
        image = PIL.Image.open(loc)
        photo = ImageTk.PhotoImage(image.resize((1490,850),PIL.Image.ANTIALIAS), master=inte)
    ...
    def monday3():
        ...
        loc='Monday3.png'
        image = PIL.Image.open(loc)
        photo = ImageTk.PhotoImage(image.resize((600,700),PIL.Image.ANTIALIAS), master=mon3)
    ...
    def tuesday3():
        ...
        loc='Tuesday3.png'
        image = PIL.Image.open(loc)
        photo = ImageTk.PhotoImage(image.resize((600,700),PIL.Image.ANTIALIAS), master=tue3)
    ...
    def thursday3():
        ...
        loc='Thursday3.png'
        image = PIL.Image.open(loc)
        photo = ImageTk.PhotoImage(image.resize((600,700),PIL.Image.ANTIALIAS), master=thu3)
    ...
    def friday3():
        ...
        loc='Friday3.png'
        image = PIL.Image.open(loc)
        photo = ImageTk.PhotoImage(image.resize((600,700),PIL.Image.ANTIALIAS), master=fri3)
    ...
    def saturday3():
        ...
        loc='Saturday3.png'
        image = PIL.Image.open(loc)
        photo = ImageTk.PhotoImage(image.resize((600,700),PIL.Image.ANTIALIAS), master=sat3)
    ...
    def advanced():
        ...
        loc='wpf.jpg'
        image = PIL.Image.open(loc)
        photo = ImageTk.PhotoImage(image.resize((1490,850),PIL.Image.ANTIALIAS), master=adva)
...
def bmii():
    ...
    loc='bmibg1.jpg'
    image = PIL.Image.open(loc)
    photo = ImageTk.PhotoImage(image.resize((1500,800),PIL.Image.ANTIALIAS))
    ...
    loc='bmi-chart.png'
    image = PIL.Image.open(loc)
    photo = ImageTk.PhotoImage(image.resize((650,450),PIL.Image.ANTIALIAS))
    label = Label(bm, image = photo)
    label.image = photo
...
def homepg():
    ...
    loc='final.jpg'
    image = PIL.Image.open(loc)
    photo = ImageTk.PhotoImage(image.resize((1490,850),PIL.Image.ANTIALIAS), master=hp)
    ...
    loc='logo.jpg'
    image = PIL.Image.open(loc)
    photo = ImageTk.PhotoImage(image.resize((120,80),PIL.Image.ANTIALIAS), master=hp)
    label = Label(hp, image = photo)
    label.image = photo
    label.place(x=0,y=0)
    ...
    def update_pic():
        ...
        loc+='.jpg'
        image = PIL.Image.open(loc)
        photo = ImageTk.PhotoImage(image.resize((750, 500),PIL.Image.ANTIALIAS))
        label = Label(hp, image = photo)
        label.image = photo
    ...
    photo=ImageTk.PhotoImage(image.resize((20, 10),PIL.Image.ANTIALIAS))
    ...
    photo1=ImageTk.PhotoImage(image1.resize((20, 10),PIL.Image.ANTIALIAS))
...
def signin():
    ...
    loc='final.jpg'
    image = PIL.Image.open(loc)
    photo = ImageTk.PhotoImage(image.resize((1490,850),PIL.Image.ANTIALIAS),master=insign)
    ...
    loc='logo.jpg'
    image = PIL.Image.open(loc)
    photo = ImageTk.PhotoImage(image.resize((300,200),PIL.Image.ANTIALIAS), master=insign)
    label = Label(insign, image = photo)
    label.image = photo
...
def profilemy():
    ...
    loc='bgpro.jpg'
    image = PIL.Image.open(loc)
    photo = ImageTk.PhotoImage(image.resize((464,646),PIL.Image.ANTIALIAS),master=profile)
...
def signup():
    ...
    loc='final.jpg'
    image = PIL.Image.open(loc)
    photo = ImageTk.PhotoImage(image.resize((1490,850),PIL.Image.ANTIALIAS),master=upsign )
    ...
    loc='logo.jpg'
    image = PIL.Image.open(loc)
    photo = ImageTk.PhotoImage(image.resize((300,200),PIL.Image.ANTIALIAS), master=root)
...
def main():
    ...
    loc='final.jpg'
    image = PIL.Image.open(loc)
    photo = ImageTk.PhotoImage(image.resize((1490,850),PIL.Image.ANTIALIAS), master=mainwindow)
    ...
    loc='logo.jpg'
    image = PIL.Image.open(loc)
    photo = ImageTk.PhotoImage(image.resize((300,200),PIL.Image.ANTIALIAS), master=mainwindow)
